...
export function FormPesan({ onNavigate, activeUser, params, onOrderCreated }: FormPesanProps) {
  ...
  const adminFee = Math.round(jasa.price * 0.05);
  const total = jasa.price + adminFee;
