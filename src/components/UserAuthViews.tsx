  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    if (found) {
      ...
      if (savedView) {
        ...
        onNavigate(found.role === 'pencari' ? 'dashboard-pencari' : 'dashboard-penyedia');
      }
    } else {
      ...
      {activeTab === 'masuk' ? (
        ...
        <form onSubmit={handleLoginSubmit} className="space-y-4">
          <div className="space-y-1">
            <label className="text-[10px] font-extrabold tracking-wider uppercase text-gray-500 block font-mono">Email Mahasiswa</label>
        ...
        <form onSubmit={handleRegisterSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-extrabold tracking-wider uppercase text-gray-500 block font-mono">Email Kampus / Aktif</label>
              <div className="relative">
